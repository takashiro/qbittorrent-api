export interface Torrent {
	 ...
	 * seeding_time_limit is a per torrent setting, when Automatic Torrent Management is disabled,
	 * furthermore then max_seeding_time is set to seeding_time_limit for this torrent.
	 * If Automatic Torrent Management is enabled, the value is -2.
